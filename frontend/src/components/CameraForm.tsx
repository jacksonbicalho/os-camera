    ...
    <form onSubmit={handleSubmit} className="flex flex-col gap-4">
      ...
      <div className="border-t border-gray-800 pt-3">
        <button
          ...
          className="flex items-center gap-1.5 text-xs font-medium text-gray-400 hover:text-gray-200 transition-colors cursor-pointer"
        >
        ...
        {showAdvanced && (
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-3 mt-3">
            ...
            <div className="sm:col-span-2 mt-1">
              <p className="text-xs font-medium text-gray-500">HLS (ao vivo)</p>
            </div>
            <div>
